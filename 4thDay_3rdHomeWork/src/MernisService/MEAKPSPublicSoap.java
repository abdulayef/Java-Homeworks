...
public class MEAKPSPublicSoap
{
    ...
    public MEAKPSPublicSoap(){}

    public MEAKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public MEAKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        MEAExtendedSoapSerializationEnvelope envelope= new MEAExtendedSoapSerializationEnvelope(MEAExtendedSoapSerializationEnvelope.VER11);
