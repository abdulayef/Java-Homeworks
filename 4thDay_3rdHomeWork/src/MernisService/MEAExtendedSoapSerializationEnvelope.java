...
public class MEAExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(MEADateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new MEAStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static MEADateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static MEADateTimeConverter dateTimeConverter = new MEAStandardDateTimeConverter();

    public MEAExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public MEAExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new MEAMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=MEAHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,MEAExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=MEAHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
