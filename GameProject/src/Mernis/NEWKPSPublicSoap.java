...
public class NEWKPSPublicSoap
{
    ...
    public NEWKPSPublicSoap(){}

    public NEWKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public NEWKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        NEWExtendedSoapSerializationEnvelope envelope= new NEWExtendedSoapSerializationEnvelope(NEWExtendedSoapSerializationEnvelope.VER11);
