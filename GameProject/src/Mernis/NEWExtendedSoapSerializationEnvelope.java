...
public class NEWExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(NEWDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new NEWStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static NEWDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static NEWDateTimeConverter dateTimeConverter = new NEWStandardDateTimeConverter();

    public NEWExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public NEWExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new NEWMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=NEWHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,NEWExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=NEWHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
