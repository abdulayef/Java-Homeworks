...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        StudentManager studentManager=new StudentManager(birol);
        InsructorManager insructorManager=new InsructorManager(engin);
        UserManager userManager=new UserManager();

        userManager.add(users);
        insructorManager.addLessons();
        studentManager.completeLessons();
